    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-12">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start md:items-center">
            ...
            <div className="space-y-2 flex-1">
              <div className="flex items-center gap-3">
                ...
                <Badge
                  className={`${isActive ? "bg-emerald-400" : "bg-rose-400"} text-slate-900 border-none px-3 font-bold`}
                >
            ...
            <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/20 text-center min-w-[180px]">
              ...
              <div className="flex justify-between items-end gap-4 mt-2">
                <div className="text-left">
                  ...
                  <p className="text-[8px] uppercase font-bold text-white/60">
                    Used
                  </p>
                </div>
              ...
              <div className="w-full h-1.5 bg-white/20 rounded-full mt-3 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${coupon.maxUses ? (coupon.currentUses / coupon.maxUses) * 100 : 100}%`,
                  }}
                />
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="border-none shadow-sm flex items-center p-6 gap-4">
          ...
          <div>
            <p className="text-xs text-muted-foreground uppercase font-black tracking-wider">
              Offer Details
            </p>
        ...
        <Card className="border-none shadow-sm flex items-center p-6 gap-4">
          ...
          <div>
            ...
            <p className="text-lg font-bold">
              {coupon.currentUses} Sales Influenced
            </p>
          </div>
        </Card>
      </div>
        ...
        <TabsContent value="usage" className="mt-0">
          <Card className="border-none shadow-sm overflow-hidden">
            <CardHeader className="bg-slate-50/10 border-b">
              ...
              <CardDescription>
                Track every transaction where this coupon was applied.
              </CardDescription>
            </CardHeader>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-slate-50/50">
                    <TableHead className="px-6 py-4 font-bold text-slate-800 uppercase text-[10px] tracking-widest">
                      Transaction ID
                    </TableHead>
                    <TableHead className="px-6 py-4 font-bold text-slate-800 uppercase text-[10px] tracking-widest">
                      Student
                    ...
                    <TableHead className="px-6 py-4 font-bold text-slate-800 uppercase text-[10px] tracking-widest text-right">
                      Date
                    </TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {coupon.payments.length === 0 ? (
                    ...
                    coupon.payments.map((p) => (
                      <TableRow
                        key={p.id}
                        className="hover:bg-slate-50/30 transition-colors border-b"
                      >
